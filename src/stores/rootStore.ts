...
export const useRootStore = defineStore('root', {
  ...
  getters: {
     ...
     * in Pacific timezone.
     */
    getCurrentDate (state): IsoDatePacific {
    ...
    showFetchingDataSpinner (state): boolean {
    ...
    getStateFiling (state): StateFilingIF {
