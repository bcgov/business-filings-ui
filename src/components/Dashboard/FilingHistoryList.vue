<template>
  <div id="filing-history-list">
    ...
    <v-card v-if="hasCourtOrders" class="my-6 pa-6" elevation="0">
      ...
      <span class="ml-1">Court order(s) have been filed on this company. Review the filing history for
        impacts to business information.</span>
    </v-card>
...
export default class FilingHistoryList extends Vue {
  ...
  protected is (filing: ApiFilingIF): string {
    switch (true) {
      ...
      case EnumUtilities.isTypeStaff(filing): return 'staff-filing'
