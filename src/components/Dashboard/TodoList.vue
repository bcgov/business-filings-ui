    ...
    >
      <v-expansion-panel
        ...
        :class="{
          ...
          'pay-error': EnumUtilities.isStatusDraft(item) && isPayError(item)
        }"
      >
          ...
          <div class="list-item">
            <div class="todo-label pt-1">
              ...
              >
                ...
                <!-- new todo task -->
                <div
                  v-else-if="EnumUtilities.isStatusNew(item)"
                  class="todo-subtitle"
                >
                  <span v-if="!!item.subtitle">{{ item.subtitle }}</span>
                </div>
                ...
                <div
                  v-else-if="EnumUtilities.isStatusDraft(item) && isPayError(item)"
                  class="todo-subtitle"
                >
                ...
                <div
                  v-else-if="EnumUtilities.isStatusDraft(item) && item.isAlteringToBen && !isGoodStanding"
                ...
                <!-- draft amalgamation -->
                <div
                  v-else-if="EnumUtilities.isStatusDraft(item) && EnumUtilities.isTypeAmalgamationApplication(item)"
                  class="todo-subtitle"
                >
                ...
                <!-- draft incorporation -->
                <div
                  v-else-if="EnumUtilities.isStatusDraft(item) && EnumUtilities.isTypeIncorporationApplication(item)"
                  class="todo-subtitle"
                >
                  <span>{{ item.subtitle }}</span>
                </div>
                ...
                <!-- draft registration -->
                <div
                  v-else-if="EnumUtilities.isStatusDraft(item) && EnumUtilities.isTypeRegistration(item)"
                  class="todo-subtitle"
                >
                  <span>{{ item.subtitle }}</span>
                </div>
                ...
                <div
                  ...
                  class="todo-subtitle"
                >
                  <template v-if="EnumUtilities.isTypeCorrection(item) || EnumUtilities.isTypeAlteration(item)">
                ...
                <!-- error filing -->
                <div
                  v-else-if="EnumUtilities.isStatusError(item)"
                  class="todo-subtitle"
                >
                  <span>FILING PENDING</span>
                  <span class="vert-pipe" />
                ...
                <!-- paid filing -->
                <div
                  v-else-if="EnumUtilities.isStatusPaid(item)"
                  class="todo-subtitle"
                >
                  <span>FILING PENDING</span>
                  <span class="vert-pipe" />
            ...
            >
              <div style="width:100%">
                ...
                <template
                  v-if="isBaseCompany && item.enabled && EnumUtilities.isTypeAnnualReport(item) &&
                    EnumUtilities.isStatusNew(item)"
                >
                ...
                <!-- new annual report -->
                <template v-else-if="EnumUtilities.isStatusNew(item) && EnumUtilities.isTypeAnnualReport(item)">
                  <v-btn
                    class="btn-file-now"
                    color="primary"
                ...
                <template
                  v-else-if="EnumUtilities.isStatusNew(item) && EnumUtilities.isTypeConversion(item) && isRoleStaff"
                >
                  <v-btn
                    class="btn-file-now"
                    color="primary"
                ...
                <!-- draft filing - other -->
                <template v-else-if="EnumUtilities.isStatusDraft(item)">
                  <v-btn
                  ...
                  >
                    ...
                    <v-list class="actions__more-actions py-2">
                      ...
                      >
                        ...
                        <v-list-item-title v-else-if="EnumUtilities.isTypeSpecialResolution(item)">
                          Delete Special Resolution
                        </v-list-item-title>
                        <v-list-item-title v-else-if="EnumUtilities.isTypeAlteration(item)">
                ...
                <!-- pending filing -->
                <template v-else-if="EnumUtilities.isStatusPending(item) && !item.isPayCompleted">
                  <v-btn
                ...
                <!-- error filing -->
                <template v-else-if="EnumUtilities.isStatusError(item)">
                  <v-btn
        ...
        <v-expansion-panel-content>
          ...
          <template v-if="EnumUtilities.isStatusDraft(item) && isPayError(item)">
            <PaymentIncomplete :filing="item" />
          </template>

          <!-- is this a conversion in any status? -->
          <template v-else-if="EnumUtilities.isTypeConversion(item)">
            <ConversionDetails
              :filing="item"
              class="mb-4"
            />
          ...
          <template v-else-if="EnumUtilities.isStatusPaid(item) || item.isPayCompleted">
            <PaymentPaid />
          </template>
        </v-expansion-panel-content>
      </v-expansion-panel>
...
export default class TodoList extends Mixins(AllowableActionsMixin, DateMixin) {
  ...
  showAnnualReportCheckbox (item: TodoItemIF): boolean {
    return (
      ...
      this.businessId &&
      this.isBaseCompany &&
      EnumUtilities.isTypeAnnualReport(item) &&
      EnumUtilities.isStatusNew(item)
    )
  }
  ...
  showDetailsBtnRed (item: TodoItemIF): boolean {
    if (EnumUtilities.isStatusDraft(item) && EnumUtilities.isTypeCorrection(item)) return true
    if (EnumUtilities.isStatusDraft(item) && this.isPayError(item)) return true
    if (EnumUtilities.isStatusError(item) && (this.inProcessFiling !== item.filingId)) return true
    if (EnumUtilities.isStatusPaid(item) && (this.inProcessFiling !== item.filingId)) return true
    return false
  }
