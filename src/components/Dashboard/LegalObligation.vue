  ...
  <div v-if="showLegalObligation && isBusinessWithNoMaintenanceFilings" class="legal-obligation-container">
    <v-card flat class="legal-obligation-section">
      ...
      <div class="share-structure-check-text">
        <span class="bold-text">Legal Obligations:</span> You are required by the Business Corporations Act to keep the
        information about your corporation up to date with the Registrar: For example, you must file annual reports,
        ...
        <div class="legal-obligation-btn-panel">
          <v-btn id="dismiss-btn"
            color="primary" @click="showLegalObligation = false" height="25" width="90">Dismiss</v-btn>
        </div>
      </div>
    </v-card>
  </div>
