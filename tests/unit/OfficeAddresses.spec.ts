...
describe('OfficeAddresses as a COOP', () => {
  ...
  it('fetches the original office addresses with different delivery and mailing', async () => {
    ...
    // mock GET addresses
    sinonAxiosGet
      .withArgs('https://business-api.url/v2/businesses/CP0000841/addresses?date=2020-11-16')
...
describe('OfficeAddresses as a BCOMP', () => {
  ...
  it('fetches the original office addresses with different registered and records', async () => {
    ...
    // mock GET addresses
    sinonAxiosGet
      .withArgs('https://business-api.url/v2/businesses/BC1218881/addresses?date=2020-11-16')
      .returns(new Promise(resolve => resolve({
        data: {
          registeredOffice: {
            deliveryAddress: address1,
