...
describe('Date Mixin', () => {
  ...
  it('returns correct values for apiToSimpleDateTime()', () => {
    expect(vm.apiToSimpleDateTime('2021-01-01T00:00:00+00:00')).toBe('2020-12-31 4:00:00 PM') // PST
    expect(vm.apiToSimpleDateTime('2021-07-01T00:00:00+00:00')).toBe('2021-06-30 5:00:00 PM') // PDT
  })
