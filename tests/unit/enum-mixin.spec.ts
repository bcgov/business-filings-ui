...
describe('Enum Mixin', () => {
  ...
  it('returns correct values for filing type helpers', () => {
    ...
    expect(vm.isTypeAdministrativeDissolution({ name: 'dissolution', dissolutionType: 'administrative' })).toBe(true)
    expect(vm.isTypeInvoluntaryDissolution({ name: 'dissolution', dissolutionType: 'involuntary' })).toBe(true)
    expect(vm.isTypeVoluntaryDissolution({ name: 'dissolution', dissolutionType: 'voluntary' })).toBe(true)
  ...
  it('returns correct values for filingTypeToName()', () => {
    ...
    expect(vm.filingTypeToName('restoration', null, 'fullRestoration')).toBe('Full Restoration')
    expect(vm.filingTypeToName('restoration', null, 'limitedRestoration')).toBe('Limited Restoration')
  ...
  it('returns correct values for dissolutionTypeToName()', () => {
    ...
    expect(vm.dissolutionTypeToName('involuntary')).toBe('Involuntary Dissolution')
