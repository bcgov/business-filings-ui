...
describe('Standalone Office Address Filing - Part 2D - Resuming (BCOMP)', () => {
  ...
  beforeEach(() => {
    ...
    // mock "fetch a draft filing" endpoint
    sinon.stub(axios, 'get').withArgs('https://business-api-gw.url/v2/businesses/BC0007291/filings/123')
      .returns(new Promise(resolve => resolve({
        data: {
          filing: {
            changeOfAddress: {
...
describe('Standalone Office Address Filing - Part 3 - Submitting', () => {
  ...
  beforeEach(() => {
    ...
    // mock "fetch a draft filing" endpoint
    sinonAxiosGet.withArgs('https://business-api-gw.url/v2/businesses/CP0001191/filings/123')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
    ...
    sinonAxiosGet.withArgs('https://business-api-gw.url/v2/businesses/CP0001191/tasks')
      .returns(new Promise(resolve => resolve({
        data: {
          'tasks': [
            {
...
describe('Standalone Office Address Filing - Part 3B - Submitting (BCOMP)', () => {
  ...
  beforeEach(() => {
    ...
    // mock "fetch a draft filing" endpoint
    sinonAxiosGet.withArgs('https://business-api-gw.url/v2/businesses/BC0007291/filings/123')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
    ...
    sinonAxiosGet.withArgs('https://business-api-gw.url/v2/businesses/BC0007291/tasks')
      .returns(new Promise(resolve => resolve({
        data: {
          'tasks': [
            {
    ...
    // mock "save and file" endpoint
    sinon.stub(axios, 'post').withArgs('https://business-api-gw.url/v2/businesses/BC0007291/filings')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
    ...
    // mock "update and file" endpoint
    sinon.stub(axios, 'put').withArgs('https://business-api-gw.url/v2/businesses/BC0007291/filings/123')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
...
describe('Standalone Office Address Filing - Part 4B - Saving (BCOMP)', () => {
  ...
  beforeEach(() => {
    ...
    // mock "save draft" endpoint
    sinon.stub(axios, 'post').withArgs('https://business-api-gw.url/v2/businesses/BC0007291/filings?draft=true')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
    ...
    sinon.stub(axios, 'get').withArgs('https://business-api-gw.url/v2/businesses/BC0007291/tasks')
      .returns(new Promise(resolve => resolve({
        data: {
          'tasks': [
            {
...
describe('Standalone Office Address Filing - Part 5B - Data (BCOMP)', () => {
  ...
  beforeEach(() => {
    ...
    // mock "save draft" endpoint
    spy = sinon.stub(axios, 'post').withArgs('https://business-api-gw.url/v2/businesses/BC0007291/filings?draft=true')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
